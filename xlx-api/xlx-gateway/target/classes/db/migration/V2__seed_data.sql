...
-- ============================================================
INSERT IGNORE INTO admin_user (username, password, nickname, role, status) VALUES
('admin', '$2a$12$b49isKSb7mT6faoHLcjVXOZAbfBuVLpVAzJwlazsuq7nm6uUcvoRm', '管理员', 'admin', 1);

-- ============================================================
-- 产品分类
-- ============================================================
INSERT IGNORE INTO product_category (id, parent_id, name_cn, name_en, slug, sort_order, status) VALUES
...
('banner_subtitle', '23年丝网生产经验，支持标准规格供应与定制加工，服务国内外客户。', '首页Banner副标题'),
