...
('site_name', '安平县鑫联信金属丝网厂', '网站名称'),
('company_name', '安平县鑫联信金属丝网厂', '公司名称'),
('company_name_en', 'ANPING XINLIANXIN WIRE MESH FACTORY', '公司英文名'),
('phone', '', '联系电话'),
('email', '', '邮箱'),
('wechat', '', '微信'),
('whatsapp', '', 'WhatsApp'),
...
('seo_title', '安平县鑫联信金属丝网厂 — 不锈钢丝、丝网、金属丝产品', 'SEO标题'),
('seo_description', '安平县鑫联信金属丝网厂，专业生产不锈钢丝、钛丝、蒙乃尔丝、铜丝及各类丝网产品，支持标准规格与定制加工。', 'SEO描述');
