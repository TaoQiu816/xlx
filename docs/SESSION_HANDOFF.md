...
鑫连鑫丝网厂（南通）B2B 官网与销售系统。当前阶段：V2.2 询价车已完成，可进入下一阶段。
...
| 阶段 | 说明 |
|------|------|
| V2.3 | 产品规格动态化 / 工厂视频 / 询盘邮件通知 |
| V3 | 订单/支付系统 |
| V4 | AI 客服/ERP 对接 |

## 9. 必须遵守的限制

1. **Flyway 已执行的迁移文件（V1-V9）永远不要修改**
2. 需要改表结构时创建新版本文件（V10、V11...）
3. 产品数据从数据库读取，不得写死
